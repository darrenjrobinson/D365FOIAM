@{
    RootModule           = 'D365FOIAM.psm1'
    ModuleVersion        = '1.0.1'
    GUID                 = '6c239fa6-04f6-4ddb-9552-9693d47fb800'
    Author               = 'Darren J Robinson'
    Copyright            = '(c) 2025 Darren J Robinson. All rights reserved.'
    Description          = "Wrapper and Helper Functions for d365fo.tools and d365fo.integrations"
    PowerShellVersion    = '5.1'
    CompatiblePSEditions = 'Core', 'Desktop'
    FunctionsToExport    = @('Set-D365FOGlobals',
        'Get-D365FOPersonUsers',
        'Get-D365FOSystemUsers',
        'Get-D365FOSystemUserSchema',
        'Get-D365FOPersonUsers',
        'Get-D365FOSecurityUserRolesSchema',
        'Get-D365FOSecurityUserRoles',
        'Get-D365FOSecurityUserRoleAssociations',
        'New-D365FOSystemUser',
        'Update-D365FOSystemUser',
        'Add-D365FORoleToSystemUser',
        'Remove-D365FORoleFromSystemUser'
    )
    PrivateData          = @{
        PSData = @{
            ProjectUri = 'https://github.com/darrenjrobinson'
        } 
    } 
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCPPLMXVU7abNc/
# oB3S3jeWwYi0d2hUYtEhisIuiyr1ZqCCISgwggWNMIIEdaADAgECAhAOmxiO+dAt
...
# CzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEINRHpjZZVB3C3kkMoI/f
# w4kD2f4b5Zt/78rblucavt4/MA0GCSqGSIb3DQEBAQUABIICAA+8VRuCnmeR428y
# /3YMOpbQkGBJ+4jlD8Zlyq2Vgpin+XzI0x+oN2xYZWPlhOf7Qh+J0+CoEcbeaTKk
# bBk7ZguuGRVNgUkDC0VzOWcdKViSfCYZPpz8vUUC7FJuR0WCD1o4JB9CI3B0MsQt
# 9YEud2dZl/QnmyE6X/745+QXdUU5bM+fbdRtc2SUJKaIczYMNnlvEqqGXweqBE8l
# tK9l1F429IasU1whstsozr07kQiOdCQs6K32guEEm6sUNfVV5fmPkN/sjOVSBnrr
# TOP6ikiNprJCYNookWRu2hFOyYrmJV4nt4za6pz8yjtNyR6hu22EJXYDqlDxtEvH
# b2CglMcGp0yh4WV819SCudFbvCp6COv2YCkZljLHUMnx68ilbb1I2tS4NWlzamS1
# Wsyu2n/V+cbgzEc0DBQ7vD+7w25Wg8UWZlLioVa0wXqNwwtUvRXsAwEJZnEJ8clP
# UJDcZ4lk3C6qzCguM+MGk4YguJCCyZeainQfYwEIJkiPhcx3G/iZ/C8K/+HNAq2a
